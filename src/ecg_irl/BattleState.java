...
public class BattleState extends GameState{
	...
	/** Toggles for correct answers, incorrect answers, and initialization. */
	...
	/** The decoy answers (incorrect answer choices). */
	...
	/** The paper background image. */
	private BufferedImage paper = null;
	
	/** Classroom State initialization. */
	ClassroomState c;
	 ...
	 * @param sub the game substate
	 * @param stateClass the substate
	 * @param c the classroom state
	 */
	...
	public void init() {
		...
		/** Each state represents a classroom **/
		if(state == Game.SUBSTATE.BATTLEBAUMAN){
			/** The questions for each of the classrooms.**/
		...
		/**The correct answers to the questions**/
			...
			//DO NOT CHANGE THE ""
		/**The incorrect answers to the questions**/
	...
	/* (non-Javadoc)
	 * @see ecg_irl.GameState#draw(java.awt.Graphics)
	 */
	@Override
	/**The battle logic. Draws the questions and lets the user answer them **/
	...
	/* (non-Javadoc)
	 * @see ecg_irl.GameState#keyPressed(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ecg_irl.GameState#keyReleased(int)
	 */
	@Override
	/**Lets the user press keys for each of the answer choices**/
